...
caps_lock_patch_sha256=9f47e4d4a8942d00df00baea0804f0d7450bdaee2a5228ff1e1b0d332d44c239
...
[[ -f $caps_lock_patch && ! -L $caps_lock_patch ]] || \
...
log "Applying the exact render, identity, display, immersive, keyboard, audio, folder, and Darwin compatibility patches"
...
patch -d "$source_dir" -p1 -f -i "$caps_lock_patch"
