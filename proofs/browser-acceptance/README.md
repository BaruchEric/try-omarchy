...
stale PASS. Rootfs and migration-state/delta GETs must be exact ranges no
larger than 8 MiB, carry the artifact digest in `If-Match`, return 206, and
return exactly the requested byte count.
